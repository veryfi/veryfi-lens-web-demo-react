...
export interface FilesIconProps extends IconProps { }

const FilesIcon = ({ color, width, height, additionalCss }: FilesIconProps) => {
  return (
    <svg
      className={`${
